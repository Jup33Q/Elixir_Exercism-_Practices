defmodule GottaSnatchEmAll do
  ...
  def boring_cards(collections) do
      ...
      collections |> boring_cards_as_set |> Enum.to_list()
...
def boring_cards_as_set([only_collection]),do: only_collection
  ...
  def split_shiny_cards(collection) do
    shiny_cards =collection |> Enum.filter(&(&1 |> String.starts_with?("Shiny ")))
    normal_cards =collection |> Enum.reject(&(&1 |> String.starts_with?("Shiny ")))
